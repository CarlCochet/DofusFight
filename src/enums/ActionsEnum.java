...
public enum ActionsEnum {
    ACTION_ENCAPSULATE_BINARY_COMMAND,
    ACTION_ENDS_TURN,
    ACTION_INTERNAL_SEND_ACTION_BUFFER,
    ACTION_NO_OPERATION,
    ACTION_SEQUENCE_START ,
    ACTION_SEQUENCE_END,
    ACTION_CHARACTER_MOVEMENT,
    ...
    ACTION_QUEST_RESET,
    ACTION_START_DIALOG_WITH_NPC,
    ACTION_CARRY_CHARACTER,
    ACTION_THROW_CARRIED_CHARACTER,
    ACTION_NO_MORE_CARRIED,
    ACTION_CHARACTER_MOVEMENT_POINTS_STEAL,
    ...
    ACTION_CHARACTER_ACTION_POINTS_STEAL,
    ...
    ACTION_CHARACTER_LIFE_POINTS_MALUS,
    ...
    ACTION_CHARACTER_LIFE_LOST_CASTER_MODERATOR,
    ACTION_CHARACTER_SPELL_REFLECTOR,
    ...
    ACTION_CHARACTER_MULTIPLY_DAMAGES,
    ...
    ACTION_CHARACTER_DEBOOST_DAMAGES_PERCENT,
    ...
    ACTION_CHARACTER_CHANGE_COLOR,
    ACTION_CHARACTER_CHANGE_LOOK,
    ACTION_CHARACTER_ADD_APPEARANCE,
    ACTION_CHARACTER_DEBOOST_CHANCE,
    ...
    ACTION_CHARACTER_BOOST_DODGE,
    ACTION_CHARACTER_BOOST_TACKLE,
    ACTION_CHARACTER_DEBOOST_DODGE,
    ACTION_CHARACTER_DEBOOST_TACKLE,
    ACTION_CHARACTER_BOOST_WEAPON_DAMAGE_PERCENT,
    ACTION_CHARACTER_DEBOOST_ACTION_POINTS,
    ...
    ACTION_CHARACTER_ALIGNMENT_RANK_SET,
    ...
    ACTION_CHARACTER_INVENTORY_ADD_ITEM_NOCHECK,
    ACTION_CHARACTER_INVENTORY_ADD_ITEM_RANDOM_NOCHECK,
    ACTION_CHARACTER_INVENTORY_ADD_ITEM_FROM_RANDOM_DROP,
    ACTION_CHARACTER_INVENTORY_GAIN_KAMAS,
    ...
    ACTION_CHARACTER_INVENTORY_ADD_ITEM_ON_RP_MAP,
    ACTION_CHARACTER_INVENTORY_REMOVE_ITEM_ON_RP_MAP,
    ACTION_DECORS_PLAY_OBJECT_ANIMATION,
    ...
    ACTION_DECORS_PLAY_ANIMATION_UNLIGHTED,
    ACTION_CHARACTER_BOOST_EARTH_ELEMENT_PERCENT,
    ...
    ACTION_CHARACTER_LIFE_POINTS_LOST_BASED_ON_CASTER_LIFE_MISSING_FROM_WATER,
    ...
    ACTION_CHARACTER_BOOST_SHIELD_BASED_ON_CASTER_LIFE,
    ACTION_CHARACTER_BOOST_SHIELD,
    ACTION_CHARACTER_ADD_SPELL_COOLDOWN,
    ACTION_CHARACTER_REMOVE_SPELL_COOLDOWN,
    ACTION_CHARACTER_UPDATE_BOOST,
    ACTION_CHARACTER_BOOST_DISPELLED,
    ACTION_BOOST_SPELL_RANGE,
    ...
    ACTION_CHARACTER_STEAL_RANGE,
    ACTION_FIGHT_ADD_TRAP_CASTING_SPELL,
    ACTION_FIGHT_ADD_GLYPH_CASTING_SPELL,
    ACTION_FIGHT_ADD_GLYPH_CASTING_SPELL_ENDTURN,
    ACTION_FIGHT_KILL_AND_SUMMON,
    ACTION_INTERACTIVE_ELEMENT,
    ACTION_SKILL_ANIMATION,
    ACTION_EXCHANGE_CRAFT_OPEN,
    ACTION_USE_WAYPOINT,
    ACTION_DO_ELEMENT_PARAMETERIZED_OPERATION,
    ACTION_INTERACTIVE_ELEMENT_AT_HOME_INNER_DOOR,
    ...
    ACTION_USE_PRISM,
    ACTION_ADD_PRISM,
    ACTION_GOTO_WAYPOINT,
    ACTION_GOTO_MAP,
    ACTION_CHARACTER_LEARN_JOB,
    ...
    ACTION_NOOP,
    ACTION_INCARNATION,
    ACTION_CHARACTER_REFERENCEMENT,
    ACTION_ITEM_CHANGE_EFFECT,
    ACTION_ITEM_ADD_EFFECT,
    ACTION_ITEM_ADD_DURABILITY,
    ACTION_CAPTURE_SOUL,
    ACTION_CAPTURE_RIDE,
    ACTION_CHARACTER_ADD_COST_TO_ACTION,
    ACTION_LADDER_SUPERRACE,
    ACTION_LADDER_RACE,
    ACTION_LADDER_ID,
    ACTION_PVP_LADDER,
    ACTION_VICTIM_OF,
    ...
    ACTION_TELEPORT_NEAREST_PRISM,
    ACTION_AUTO_AGGRESS_ENEMY_PLAYER,
    ACTION_SHUSHU_STACK_RUNE,
    ACTION_BOOST_SOUL_CAPTURE_BONUS,
    ACTION_BOOST_RIDE_XP_BONUS,
    ACTION_REMOVE_ON_MOVE,
    ACTION_CHARACTER_SACRIFY,
    ACTION_HOURLY_CONFUSION_DEGREE,
